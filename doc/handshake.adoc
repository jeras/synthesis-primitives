...
might not provide registers with clock enable,
in this case a flip-flop with a feedback loop is used instead.

.Flip-flop with feedback loop implementing write enable
image::handshake/flip-flop-feedback.svg[D-type Flip-Flop with feedback]


https://skywater-pdk.readthedocs.io/en/main/contents/libraries/sky130_fd_sc_hd/cells/edfxtp/README.html
...
https://skywater-pdk.readthedocs.io/en/main/contents/libraries/sky130_fd_sc_hd/cells/dfrtp/README.html
